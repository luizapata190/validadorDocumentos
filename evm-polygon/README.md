...
# 🟩 Notario Digital - Módulo EVM (Polygon / Sepolia)

Esta carpeta contiene el código fuente del Notario Digital adaptado para la **Ethereum Virtual Machine (EVM)**. Es compatible con redes como Polygon, Ethereum Sepolia, Base, Arbitrum y Optimism.
...
* **Librería Web3:** Ethers.js `v5.7.2`
* **Billetera:** MetaMask
* **Algoritmo de Cifrado:** SHA-256 (`SubtleCrypto API`)
...
evm-polygon/
├── contracts/
│   └── Verificador.sol       # Smart Contract en Solidity
├── frontend/
│   └── index.html            # Interfaz de usuario y cliente Web3
└── README.md                 # Instructivo del módulo
⚡ Despliegue y Ejecución Local
Abre la carpeta evm-polygon/frontend/ en Visual Studio Code.

Asegúrate de configurar la dirección del contrato desplegado en la variable CONTRACT_ADDRESS de index.html.

Haz clic derecho en index.html y selecciona "Open with Live Server" (o ejecuta python -m http.server en la terminal).

Conecta tu billetera MetaMask configurada en la red Sepolia o Polygon Amoy.

📝 Información del Smart Contract
Red Actual de Pruebas: Ethereum Sepolia Testnet

Dirección del Contrato: 0x547abE743cd2561FB13cE7BfabA31cD8EFF6b95f
